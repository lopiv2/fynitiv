...
enum AudioWaveformEffect { equalizer, wave, mirror, bars, surfer, audioFlux, frequency, ledSpectrum, soundEclipse, soundSinus, raymarching, smokeRings, circularSpectrum }
