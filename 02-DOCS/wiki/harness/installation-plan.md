...
Plan id: `1e797fbbf3ed3299c1eb16da9cca433bbdb2c86ea1a2d4d592b3528cd7cb2206`
...
| agent | flutter-build-resolver | selected | The accepted substantial software workflow requires this implementation or review role. | — |
| agent | flutter-reviewer | selected | The accepted substantial software workflow requires this implementation or review role. | — |
...
| skill | flutter | selected | Detected flutter evidence inside the selected project root. | — |
...
| skill | sdd | selected | Included because the accepted work has authentication, persistence complexity. | — |
